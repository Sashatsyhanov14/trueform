...
// Use absolute URL for client-side to bypass ad-blockers and VK in-app browser restrictions
// Keep full URL for server-side
const isBrowser = typeof window !== "undefined";
const clientUrl = isBrowser ? `${window.location.origin}/supabase-proxy` : supabaseUrl;
